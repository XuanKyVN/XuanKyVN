...
class ModbusMaster
{
  public:
    ...
    */
	...
	uint16_t readHoldingRegisterUInt16(uint16_t);
	uint32_t readHoldingRegisterUInt32(uint16_t);
	uint64_t readHoldingRegisterUInt64(uint16_t);
	uint16_t readHoldingRegisterInt16(uint16_t);
	uint32_t readHoldingRegisterInt32(uint16_t);
	uint64_t readHoldingRegisterInt64(uint16_t);
	float    readHoldingRegisterFloat32(uint16_t);
	
	uint16_t readInputRegisterUInt16(uint16_t);
	uint32_t readInputRegisterUInt32(uint16_t);
	uint64_t readInputRegisterUInt64(uint16_t);
	uint16_t readInputRegisterInt16(uint16_t);
	uint32_t readInputRegisterInt32(uint16_t);
	uint64_t readInputRegisterInt64(uint16_t);
	float    readInputRegisterFloat32(uint16_t);
	
	uint8_t readDatetimeHRegister(uint16_t);
	uint8_t readDatetimeIRegister(uint16_t);
	uint8_t writeDatetimeHR(uint16_t ,uint8_t ,uint8_t ,uint16_t ,uint8_t ,uint8_t ,uint8_t );
	//------------------Write------------
    uint8_t  writeSingleCoil(uint16_t, uint8_t);
    uint8_t  writeSingleRegister(uint16_t, uint16_t);
	uint8_t  writeSingleRegisterInt16(uint16_t, int16_t);
    uint8_t  writeMultipleCoils(uint16_t, uint16_t);
    uint8_t  writeMultipleCoils();
    uint8_t  writeMultipleRegisters(uint16_t, uint16_t);
	
	uint8_t  writeMultipleRegistersU32(uint16_t, uint32_t);
	uint8_t  writeMultipleRegistersU64(uint16_t, uint64_t);
	uint8_t writeMultipleRegistersU64_1(uint16_t , uint16_t* );
	uint8_t writeMultipleRegistersU64_2(uint16_t , uint32_t ,uint32_t); 
	
  	uint8_t  writeMultipleRegistersFloat32(uint16_t, float);
	
	uint8_t writeMultipleRegistersInt32(uint16_t ,int32_t);
	uint8_t writeMultipleRegistersInt64(uint16_t,int64_t);
	uint8_t writeMultipleRegistersInt64_1(uint16_t ,int16_t*);
	uint8_t writeMultipleRegistersInt64_2(uint16_t ,int32_t ,int32_t );
